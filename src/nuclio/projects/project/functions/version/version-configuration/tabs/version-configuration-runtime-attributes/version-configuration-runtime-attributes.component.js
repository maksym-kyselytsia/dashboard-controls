    ...
    function NclVersionConfigurationRuntimeAttributesController($element, $rootScope, $timeout, lodash,
        ...
        function onInit() {
            ...
            lodash.assign(ctrl.runtimeAttributes, {
                repositories: lodash.get(ctrl.version, 'spec.runtimeAttributes.repositories', []).join('\n'),
        ...
        function inputValueCallback(newData, field) {
            switch (field) {
                case 'repositories':
                    ...
                    lodash.set(ctrl.version, 'spec.runtimeAttributes.repositories', newData.replace(/\r/g, '\n').split(/\n+/));
                    break;
                case 'jvmOptions':
